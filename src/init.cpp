...
string HelpMessage() {
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 8888 or testnet: 8889)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10000 or testnet: 10001)") + "\n";
...
bool AppInit(boost::thread_group &threadGroup) {
    ...
    auto pathLockFile = GetDataDir() / ".lock";
