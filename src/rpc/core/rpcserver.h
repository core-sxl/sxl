...
extern json_spirit::Value getchaininfo(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value submitrecordtx(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getrecord(const json_spirit::Array& params, bool fHelp);
