...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "submitcontractinvoketx", &submitcontractinvoketx, false,     false,      true  },

    /* asset */
    { "submitassetissuetx",     &submitassetissuetx,     false,     false,      true },
    { "submitassetupdatetx",    &submitassetupdatetx,    false,     false,      true },
    { "getasset",               &getasset,               true,      false,      false },
    { "listassets",             &listassets,             true,      false,      false },

    /* record */
    { "submitrecordtx",         &submitrecordtx,         false,     false,      true  },
    { "getrecord",              &getrecord,              true,      false,      false },
...
string HelpExampleRpc(string methodname, string args) {
    return "> curl --user myusername -d '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           ...
           "] }' -H 'Content-Type: application/json;' http://127.0.0.1:10000/\n";
}
