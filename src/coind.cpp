 ...
 *
 * This is the developer documentation of the reference client for a new crypto currency called SXL
 * (https://www.sikuaikeji.com/), which enables instant payments to anyone, anywhere in the world. SXL uses peer-to-peer
